    ...
    class DbModel {
        ...
        public function __set($key, $val) {
            ...
            if (isset($this->__attributes[$key])) {
                ...
                Sys::app()->logInfo([$this, $this->getFileds()], 'getFileds');
        ...
        public function getConnection() {
            return Sys::app()->db('sl_master');
        }

        public function getReadDb() {
            return Sys::app()->db('sl_slave');
        }
         ...
         * @param bool $isSlave
         * @return array|bool
         * @throws \models\error\ArgsError
         * @throws \models\error\DbError
         */
        ...
        public function getPkVal() {
            return $this->__attributes[$this->getPkField()]['value'];
        }
